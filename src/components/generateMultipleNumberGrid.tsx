...
export const GenerateMultipleNumberGrid = (props: any) => {
  ...
  return (
    <section id="number-grid-container">
      {arrayNum.map((num: number) => {
        const matchA: boolean = isMultipleOfSelected(props.selected[0], num)
        const matchB: boolean = isMultipleOfSelected(props.selected[1], num)
        let grid: gridStatus
